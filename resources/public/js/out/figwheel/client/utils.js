...
var or__28015__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34127 = {"detail":data};
return obj34127;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28003__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28003__auto__)){
var and__28003__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34134 = cljs.core._EQ_;
var expr__34135 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34134.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34135))){
return ((function (pred__34134,expr__34135){
return (function (p1__34128_SHARP_){
return console.warn(p1__34128_SHARP_);
});
;})(pred__34134,expr__34135))
} else {
if(cljs.core.truth_(pred__34134.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34135))){
return ((function (pred__34134,expr__34135){
return (function (p1__34129_SHARP_){
return console.debug(p1__34129_SHARP_);
});
;})(pred__34134,expr__34135))
} else {
if(cljs.core.truth_(pred__34134.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34135))){
return ((function (pred__34134,expr__34135){
return (function (p1__34130_SHARP_){
return console.error(p1__34130_SHARP_);
});
;})(pred__34134,expr__34135))
} else {
return ((function (pred__34134,expr__34135){
return (function (p1__34131_SHARP_){
return console.log(p1__34131_SHARP_);
});
;})(pred__34134,expr__34135))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34138){
...
var eval_fn = cljs.core.get.call(null,map__34139__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34141_SHARP_);
});})(new_def))
);
...
return (function (p__34142){
var vec__34143 = p__34142;
var ky = cljs.core.nth.call(null,vec__34143,(0),null);
var v = cljs.core.nth.call(null,vec__34143,(1),null);
...
if(cljs.core.truth_((function (){var and__28003__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__28003__auto__)){
...
//# sourceMappingURL=utils.js.map?rel=1521812297432
